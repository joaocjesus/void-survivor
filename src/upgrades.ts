...
export const UPGRADES: UpgradeDef[] = [
    ...
    { id: 'speed', name: 'Swiftness', description: `+${(UPGRADE_VALUES.MOVE_SPEED_MULT - 1) * 100}% move speed`, apply: gs => { const p = gs.entities.get(gs.playerId)!; p.speed = (p.speed || 120) * UPGRADE_VALUES.MOVE_SPEED_MULT; } },
